...
delegate: Item {
                ...
                Text {
                    id: labelText
                    anchors.centerIn: parent
                    anchors.verticalCenterOffset: ws.wsKanji ? -1 : 0
