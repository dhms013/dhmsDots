                ...
                Grid {
                    ...
                    Repeater {
                        ...
                        Item {
                            ...
                            readonly property bool isToday: isValid && dayNum === calWindow.today.getDate() && calWindow.viewMonth === calWindow.today.getMonth() && calWindow.viewYear === calWindow.today.getFullYear()
                            ...
                            Text {
                                anchors.centerIn: parent
                                text: isValid ? dayNum : ""
                                color: isToday ? (root.theme.bg || "#1e1e2e") : (root.theme.fg || "#cdd6f4")
                                opacity: isValid ? 1 : 0
                                font.pixelSize: 10
                                font.family: "JetBrainsMono Nerd Font"
