...
PanelWindow {
    ...
    function applyFilter() {
        ...
        for (var i = 0; i < allBindings.length; i++) {
            var b = allBindings[i];
            if (q === "" || b.combo.toLowerCase().indexOf(q) !== -1 || b.action.toLowerCase().indexOf(q) !== -1)
                out.push(b);
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text {
                            anchors.verticalCenter: parent.verticalCenter
                            text: root.searchText !== "" ? root.searchText : "Search keybindings…"
                ...
                ListView {
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            anchors.margins: 1
                            radius: 6
                            color: isSelected ? Qt.alpha(theme.accent || "#89b4fa", 0.12) : "transparent"
