...
THEME_BACKGROUNDS_PATH="$HOME/.config/themes/current/theme/backgrounds/"
USER_BACKGROUNDS_PATH="$HOME/Pictures/backgrounds/"
...
'
    ...
    function applyBackground(path) {
        ...
        applyProc.command = ["bash", "-lc", "background-set " + shellQuote(path)];
