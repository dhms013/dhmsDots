...
// Visual reference + live playground for dhms-shell's common UI
// components. Summon with `dhms dev ui-preview`, or directly via:
//   dhms-shell shell summon dhms.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `dhms dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("dhms.dev-gallery")
  ...
  FloatingWindow {
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("dhms.dev-gallery")
    }
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `dhms font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["dhms.clock", "dhms.weather", "dhms.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "dhms.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "dhms-shell", label: "dhms shell", description: "Shell IPC wrapper" },
