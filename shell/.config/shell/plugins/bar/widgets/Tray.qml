...
BarWidget {
  ...
  // UseQApplication` - dhms's shell.qml does not, so every submenu click was
  ...
  function persistTrayState(pinned, hidden) {
    ...
    var id = root.moduleName || "dhms.tray"
