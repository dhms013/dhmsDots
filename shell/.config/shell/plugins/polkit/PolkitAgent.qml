...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "dhms-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("dhms polkit agent registered")
      else console.warn("dhms polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "dhms-polkit"
