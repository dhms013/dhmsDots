...
--       }
--
--       vim.api.nvim_set_hl(0, "NeoTreeNormal", { bg = colors.bg0 })
--       vim.api.nvim_set_hl(0, "NeoTreeNormalNC", { link = "NeoTreeNormal" })
--       vim.api.nvim_set_hl(0, "NeoTreeDirectoryName", { fg = colors.fg3 })
--       vim.api.nvim_set_hl(0, "NeoTreeDirectoryIcon", { fg = colors.fg3 })
...
--       vim.api.nvim_set_hl(0, "NeoTreeC", { fg = colors.orange, bg = colors.bg3 })
--
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardHeader", { fg = colors.fg3 })
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardIcon", { fg = colors.fg1 })
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardDir", { fg = colors.green })
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardFile", { fg = colors.fg3 })
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardFooter", { fg = colors.fg3 })
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardKey", { fg = colors.green })
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardDesc", { fg = colors.fg1 })
--       -- vim.api.nvim_set_hl(0, "SnacksDashboardSpecial", { fg = colors.fg1 })
--     end,
--   },
--   {
--     "LazyVim/LazyVim",
