...
- $mainMod usually using windows key, but please read the note inside [keybindings.conf](./hypr/.config/hyprkeybindings.conf) or simply edit the [input.conf](./hypr/.config/hyprinput.conf)
